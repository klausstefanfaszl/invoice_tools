...
:: ============================================================
::  Parameter prüfen
::  Aufruf:  rechnungseingang_ex.bat JJJJ/MM
::      oder rechnungseingang_ex.bat MM         (aktuelles Jahr)
:: ============================================================
if "%~1"=="" (
    echo.
...
::  Pfade aufbauen
:: ============================================================
set INPUT_DIR=%BASE_DIR%\%YEAR%\%MONTH%\Eingangsrechnungen
set OUTPUT_DIR=%BASE_DIR%\%YEAR%\%MONTH%
set OUTPUT_FILE=%OUTPUT_DIR%\Rechnungseingang_%MONTH%.%FORMAT%
...
set STARTZEIT=%time%
echo.
echo  Rechnungseingang %MONTH%/%YEAR%
echo  -----------------------------------------------
